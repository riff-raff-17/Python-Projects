...
class Dinosaur:
    ...
    def __init__(self, img=RUNNING[0]):
        ...
        self.step_index = 0
        self.color = (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255)) # Added colors
    ...
    def draw(self, SCREEN):
        ...
        pygame.draw.rect(SCREEN, self.color, (self.rect.x, self.rect.y, self.rect.width, self.rect.height), 2) # Draws a rectangle around the dinosaur
...
def eval_genomes(genomes, config):
    global game_speed, x_pos_bg, y_pos_bg, points, dinosaurs, obstacles, ge, nets, score_limit # add score_limit
    clock = pygame.time.Clock()
    points = 0
    score_limit = (200 * ((pop.generation+1) // 5 + 1)) #+
    ...
    def statistics():
        global dinosaurs, game_speed, ge, score_limit
        ...
        text_4 = FONT.render(f'Score Limit: {score_limit}', True, (0, 0, 0)) # +
    ...
    while run:
        ...
        if len(dinosaurs) == 0 or points > score_limit: # +
            break
